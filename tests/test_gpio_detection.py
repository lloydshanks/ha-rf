...
class TestGPIOChipDetectionLogic:
    ...
    def test_chip_search_order_logic(self, mock_gpiod):
        ...
        with patch.object(RFDevice, '_find_gpio_chip_for_line', return_value=mock_chip_path):
    ...
    def test_pinctrl_label_filtering(self, mock_gpiod):
        ...
        with patch.object(RFDevice, '_find_gpio_chip_for_line', return_value="/dev/gpiochip0"):
            device = RFDevice(gpio=17)
...
class TestGPIOCompatibility:
    ...
    def test_pi_model_chip_mapping(self):
        ...
        assert pi_chip_mapping["pi5"] != pi_chip_mapping["pi4"]  # Different architecture
